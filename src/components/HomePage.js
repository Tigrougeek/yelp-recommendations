...
const HomePage = () => {
    ...
    useEffect(
        () => {
            console.log("use effect for city " + city_id);
            ...
            useResources(`most_popular_restaurants_reviews_${city_id}.json`).then(r => {
                setPopularRestaurants(r)
                console.log("woof woof I know some good restaurants")
                console.log(r);
            });
        },[city_id]);
    ...
    console.log("meow meow I am hungry")
